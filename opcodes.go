...
func (cpu *CPU) LDHA_memu16() {
	cpu.A = cpu.bus.read((uint16(cpu.PC + 1) << 8 | uint16(cpu.PC)) + 0xFF00)
	cpu.PC += 2
}
...
var opcodes = [256]Opcode {
	...
	Opcode{"LD A, (FF00+u8)", func(cpu *CPU) { cpu.LDHA_memu16() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"DI", func(cpu *CPU) { cpu.DI() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"NOP", func(cpu *CPU) { cpu.UND_OP() }}, Opcode{"CP A, u8", func(cpu *CPU) { cpu.CPA_r8(cpu.fetchOpcode()) }}, Opcode{"RST 0x38", func(cpu *CPU) { cpu.RST_vec(0x0038) }}, 
}
